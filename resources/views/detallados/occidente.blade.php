                ...
                <div class="card-body" id="f315-div" >
                    <table  class="display nowrap table table-striped table-bordered" style="width:100%">
                          ...
                          <tr>
                            ...
                            <td> <a href="{{ route('descargaroReporte', $idrespuesta)}}" class="btn btn-primary">Descargar PDF</a></td>
                            <td>Reporte fotográfico</td>
                            <td> <a href="{{ route('descargarofReporte', $idrespuesta)}}" class="btn btn-primary">Descargar PDF</a></td>
                          </tr>
